...
SELECT w.WKI_ID, w.WKI_REFERENCE, case WHEN w.CURRENT_STATUS_CODE1 = 12 THEN 1 ELSE 0 END as published, w.CURRENT_STATE_DATE as PublicationDate,
 w.ETSI_STANDARD_TYPE as StandardType, w.ETSI_NUMBER as Number, EDSPDFfilename as [fileName], EDSpathname as filePath, 'ETSI ' + w.ETSI_STANDARD_TYPE + ' ' + w.ETSI_NUMBER + ' v' + w.LAST_VERSION as WKI_ETSI_NUMBER
