...
SELECT     MTG_ID, MTG_CATEG_CODE, MTG_TYPE_CODE, MTGS_CODE, MTG_REF, START_DATE, END_DATE, MTG_YEAR, MTG_SEQNO, MTG_TITLE, OWNERSHIP_LEVEL, INVITATION_DATE, DEADLINE_DATE, DURATION, INVITED_NUMB, ATTENDANT_NUMB, LOCAL_FLG, ORGA_ID, 
                      ...
                      Creation_Date, csn.ShortName, [dbo].[getMeetingShortRef](csn.ShortName, MEETINGS_1.MTG_TITLE, MEETINGS_1.MTG_SEQNO) AS MtgShortRef
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_Meetings';
