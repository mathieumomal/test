...
BEGIN
	...
	exec [$(WPMDB)].[dbo].sp_ImportWorkItem 1, @ETSI_NUMBER, @STANDARD_TYPE, 1, @ETSI_DOC_NUMBER, NULL, NULL, NULL, NULL, NULL, NULL,NULL,@REFERENCE,'R',@STANDARD_TYPE, @SERIAL_NUMBER,NULL,NULL,3,8,NULL,NULL,NULL,NULL,NULL,NULL,'PU',NULL,4,
