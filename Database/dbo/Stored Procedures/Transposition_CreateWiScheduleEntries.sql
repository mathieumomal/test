...
BEGIN
	...
	exec [WPMDB].[dbo].sp_ImportSchedule @WKI_ID, 2, 2, 'TB', 'M28','TB approval',8,'','','N',NULL,NULL,@NOW,NULL,'N',NULL,NULL,'N',10, 'Y',3,NULL,@MAJOR_VERSION,@TECHNICAL_VERSION,@EDITORIAL_VERSION,'3GPP Status'
