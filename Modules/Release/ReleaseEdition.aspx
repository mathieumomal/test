                    ...
                    <telerik:RadMultiPage ID="ReleaseEditRadMultiPage" runat="server" Width="100%" BorderColor="DarkGray" BorderStyle="Solid" BorderWidth="1px" height="555px">
                        <telerik:RadPageView ID="RadPageGeneral" runat="server" Selected="true">
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td class="TabLineLeft">
                                        <asp:Label ID="ReleaseStatusLbl" runat="server" Text="Status:"></asp:Label></td>
                                ...
                                <tr>
                                    <td class="TabLineLeft">
                                        <asp:Label ID="ReleaseStartDateLbl" runat="server" Text="Start date:"></asp:Label></td>
                                    <td colspan="2" class="TabLineRight">
                                    ...
                                    <td colspan="3" class="TabLineRightFreeze">
                                        <asp:Panel ID="FreezeStagesPanel" runat="server">
                                            <fieldset id="FreezeFieldset">
                                                <legend>
                                                    <asp:Label ID="FreezeMeetingLbl" runat="server" Text="Freeze meetings and dates"></asp:Label></legend>
                                                <table style="width: 100%; vertical-align: middle" id="FrezeStagesTable">
                                                    <tr>
                                                        <td class="FirstColFreezeStageEdit" id="FirstColFreezeStage1">
                                                            <asp:Label ID="ReleaseFreezeStage1Lbl" runat="server" Text="Stage1:"></asp:Label></td>

                                                        <td class="SecndColFreezeStage">
                                                            <ult:MeetingControl runat="server" ID="FreezeStage1Meeting" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="FirstColFreezeStageEdit" id="FirstColFreezeStage2">
                                                            <asp:Label ID="ReleaseFreezeStage2Lbl" runat="server" Text="Stage2:"></asp:Label></td>

                                                        <td class="SecndColFreezeStage">
                                                            <ult:MeetingControl runat="server" ID="FreezeStage2Meeting" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="FirstColFreezeStageEdit" id="FirstColFreezeStage3">
                                                            <asp:Label ID="ReleaseFreezeStage3Lbl" runat="server" Text="Stage3:"></asp:Label></td>

                                                        <td class="SecndColFreezeStage">
                                                            <ult:MeetingControl runat="server" ID="FreezeStage3Meeting" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                <div>
                                ...
                                <tr>
                                    <td class="TabLineLeft">
                                        <asp:Label ID="ReleaseEndDateLbl" runat="server" Text="End date:"></asp:Label></td>

                                    <td class="TabLineRight">
                                        <ult:MeetingControl runat="server" ID="ReleaseEndMeeting" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="TabLineLeft">
                                        <asp:Label ID="ReleaseClosureDateLbl" runat="server" Text="Closure date:"></asp:Label></td>

                                    <td class="TabLineRight">
                                        <ult:MeetingControl runat="server" ID="ReleaseClosureMeeting" />
                                    </td>
                                </tr>
                            ...
                            <table class="TabContent" style="width: 95%">
                                ...
                                <tr>
                                    <td colspan="2" class="TabLineRight">
                                        <fieldset>
                                            <legend>
                                                <asp:Label ID="ReleaseVersionLbl" runat="server" Text="Versions"></asp:Label></legend>
                                ...
                                <tr>
                                    <td colspan="2" class="TabLineRight">
                                        <fieldset>
                                            <legend>
                                                <asp:Label ID="WPMCodesLbl" runat="server" Text="WPM codes"></asp:Label></legend>
                                            <table class="versionFieldsetTab" style="width: 100%">
                                                <tr>
