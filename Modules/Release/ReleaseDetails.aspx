    ...
    <form id="ReleaseDetailsForm" runat="server">
       ...
       <asp:Panel ID="releaseDetailsBody" runat="server" CssClass="releaseDetailsBody">
            ...
            <telerik:RadMultiPage ID="ReleaseDetailRadMultiPage" runat="server" Width="100%" BorderColor="DarkGray" BorderStyle="Solid" BorderWidth="1px">
                <telerik:RadPageView ID="RadPageGeneral" runat="server" Selected="true">        
                   <table style="width: 100%">
                        <tr>
                            ...
                            <td colspan="2" class="TabLineRight"><asp:Label ID="releaseCodeVal" runat="server" ControlName="releaseCodeVal" ></asp:Label></td>
                        </tr>                              
                        <tr>
                        ...
                        <tr>            
                            ...
                            <td colspan="2" class="TabLineRight"><asp:Label ID="ReleaseNameVal" runat="server" ControlName="ReleaseNameVal"></asp:Label></td>
                        </tr>
                        <tr>            
                            ...
                            <td colspan="2" class="TabLineRight"><img runat="server" id="ReleaseDescVal" alt="Go to description" src="images/ReleaseDecription.png"/></td>
                        ...
                        <tr>
                            <td colspan="3" class="TabLineRight">
                                <asp:Panel ID="FreezeStagesPanel" runat="server">
                                    <fieldset>
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 40%; padding-left: 15%"><asp:Label ID="ReleaseFreezeStage1Lbl" runat="server" ControlName="ReleaseFreezeStage1Lbl" Text="Stage1:"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage1Meeting" runat="server" ControlName="ReleaseFreezeStage1Meeting"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage1Date" runat="server" ControlName="ReleaseFreezeStage1Date"></asp:Label></td>
                                            </tr>                                        
                                            <tr>
                                                <td style="width: 40%; padding-left: 15%"><asp:Label ID="ReleaseFreezeStage2Lbl" runat="server" ControlName="ReleaseFreezeStage2Lbl" Text="Stage2:"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage2Meeting" runat="server" ControlName="ReleaseFreezeStage2Meeting"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage2Date" runat="server" ControlName="ReleaseFreezeStage2Date"></asp:Label></td>
                                            </tr>                                        
                                            <tr>
                                                <td style="width: 40%; padding-left: 15%"><asp:Label ID="ReleaseFreezeStage3Lbl" runat="server" ControlName="ReleaseFreezeStage3Lbl" Text="Stage3:"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage3Meeting" runat="server" ControlName="ReleaseFreezeStage3Meeting"></asp:Label></td>
                                                <td style="width: 30%"><asp:Label ID="ReleaseFreezeStage3Date" runat="server" ControlName="ReleaseFreezeStage3Date"></asp:Label></t>
                                            </tr>
                                        </table>
                                        <div>
                ...
                <telerik:RadPageView ID="RadPageAdministration" runat="server">
                ...
                <telerik:RadPageView ID="RadPageHistory" runat="server">
                    <div class="TabContent" style="overflow-y: scroll; overflow-x: auto">
