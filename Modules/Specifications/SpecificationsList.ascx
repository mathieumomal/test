                        ...
                        <telerik:RadGrid ID="rgSpecificationList" runat="server"
                            ...
                            <MasterTableView ClientDataKeyNames="Pk_SpecificationId" Width="100%" AllowNaturalSort="false">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" AllowSorting="false" DataField="PrimeResponsibleGroupShortName" HeaderText="Primary Responsible Group" HeaderTooltip="TSG or WG which has primary responsibility for the specification" UniqueName="PrimeResponsibleGroupShortName" HeaderStyle-CssClass="helpTooltip"></telerik:GridBoundColumn>
